      ...
      <div className="p-4">
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
          ...
          <ol className="text-sm text-blue-800 space-y-1 list-decimal list-inside">
            ...
            <li>Click on the specific template object (like the sign board)</li>
            <li>Click the green "Set Background" button in the toolbar</li>
            <li>Choose any image file (JPG, PNG, GIF)</li>
            <li>The image will become the background of that specific object</li>
            <li>Use "Remove Background" to clear it from the selected object</li>
          </ol>
        </div>
